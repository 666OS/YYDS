...
#示例：每周一凌晨6点下载一次
#cron=0 6 * * 1
DOWNLOAD_FILE = url=https://git.imee.me/https://github.com/666OS/YYDS/raw/main/mihomo/config/OneTouch.yaml, path=/etc/openclash/config/OneTouch.yaml, cron=0 6 * * *, force=false

#将模板作为默认配置文件
CONFIG_FILE = /etc/openclash/config/OneTouch.yaml
