...
#示例：每周一凌晨6点下载一次
#cron=0 6 * * 1
DOWNLOAD_FILE = url=https://git.imee.me/https://github.com/666OS/YYDS/raw/main/mihomo/config/MihomoPro.yaml, path=/etc/openclash/config/MihomoPro.yaml, cron=0 6 * * *, force=false
