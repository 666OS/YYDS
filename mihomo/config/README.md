...
|---------|------|--------|---------|----------|
| `MihomoPro.yaml` | v26.1.2 | ⭐⭐⭐⭐⭐ | **「经典全面掌控」** 经典测速与多策略精细分流 | 22.6 KB |
| `OneSmartPro.yaml` | v26.1.2 | ⭐⭐⭐⭐ | **「智能全面掌控」** 智能自适应与复杂拓扑中转 | 20.1 KB |
| `OneSmart.yaml` | v26.1.2 | ⭐⭐⭐ | **「智能极简」** 智能自适应与轻量极简自治 | 12.5 KB |
| `OneTouch.yaml` | v26.1.2 | ⭐⭐ | **「经典极简」** 经典测速与极致纯净轻量 | 12.4 KB |
