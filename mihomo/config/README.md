...
|---------|------|--------|---------|----------|
| `MihomoPro.yaml` | v6.0.3 | ⭐⭐⭐⭐⭐ | 专业用户，需要全功能支持 | 25.5 KB |
| `OneSmartPro.yaml` | v1.2.7 | ⭐⭐⭐⭐ | 高级用户，智能代理 + 多端口 | 21.9 KB |
| `OneSmart.yaml` | v1.2.7 | ⭐⭐⭐ | 普通用户，智能代理极简版 | 13.4 KB |
| `OneTouch.yaml` | v3.8 | ⭐⭐ | 新手用户，一键连纯净版 | 13.4 KB |
